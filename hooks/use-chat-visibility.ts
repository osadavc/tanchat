...
export function useChatVisibility({
  ...
  const updateChatVisibilityFn = useServerFn(updateChatVisibility);
  ...
  const localVisibility = useVisibilityStore(
    (state) => state.visibility[chatId] ?? initialVisibilityType
  );
